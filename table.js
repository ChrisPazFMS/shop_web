...
let table_phone = `  <!-- Liste des téléphones en stock -->
...
let button_card = `
        <button id="button_card">Panier</button>
        `
export { naveBar, article, table_phone, table_tablet, table_computer, button_card };